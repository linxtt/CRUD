	      ...
	      <div class="modal-body">
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_add_input" placeholder="Email@xtt.com" />
			      <span class="help-block"></span>
			    </div>
			  </div>
			  <div class="form-group">
	      ...
	      <div class="modal-body">
	        <form class="form-horizontal">
			  ...
			  <div class="form-group">
			    <label class="col-sm-2 control-label">邮箱</label>
			    <div class="col-sm-10">
			      <input type="text" name="email" class="form-control" id="email_update_input" placeholder="Email@xtt.com" />
			      <span class="help-block"></span>
			    </div>
			  </div>
			  <div class="form-group">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12" style="text-align: center; font-weight: bold;">	
				<h1><span class="label label-primary">SSM-CRUD</span></h1>
				<div class="btn-group" role="group">
					...
					<ul class="dropdown-menu">
						<li><a href="#">用户：${User_Session.userName}</a></li>
		...
		<div class="row">
			...
			<!-- 分页条信息 -->
			<div style="text-align: center;" class="col-md-12" id="page_nav_area">
			</div>
		</div>
	</div>
...
<script>
		...
		function build_emps_table(result) {
			//构建员工数据表格前先清空表格，防止点击下一页按钮时出现表格堆积
			...
			$.each(emps,function(index,item){
				...
				var delBn =editBtn.attr("edit-id",item.empId);
				...
				$("<tr></tr>").addClass("info").append(checkBoxTd)
					.append(empIdTd)
					.append(empNameTd).
					append(genderTd).
					append(emailTd).
		...
		function build_page_info(result) {
			...
			$("<span></span>").addClass("label label-primary").append("当前"+result.extend.pageInfo.pageNum+"页,总"+
					result.extend.pageInfo.pages+"页,总"+
					result.extend.pageInfo.total+"条记录").appendTo("#page_info_area");
		...
		function build_page_nav(result) {
			...
			var prePageLi=$("<li></li>").append($("<a></a>").append("<span aria-hidden='true'></span>").append("&laquo;"));
			...
			var nextPageLi=$("<li></li>").append($("<a></a>").append("<span aria-hidden='true'></span>").append("&raquo;"));
			...
			$.ajax({
				...
				success:function(result){
					if(result.code==200){
						...
						show_validate_msg("#empName_add_input","error",result.extend.value_message);
